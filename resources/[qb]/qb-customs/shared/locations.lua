...
Config.Locations = {
    ['Innocence'] = {
        ...
        deniedClasses = { 18 } },
        zones = {
            { coords = vector3(-193.11, -1320.21, 30.47), length = 6.0, width = 4.0, heading = 270.0, minZ = 29.88, maxZ = 33.48 },
            { coords = vector3(-210.89, -1319.7, 30.47), length = 6.0, width = 4.0, heading = 270.0, minZ = 29.88, maxZ = 33.48 },
            { coords = vector3(-240.56, -1317.68, 30.47), length = 6.0, width = 4.0, heading = 270.0, minZ = 29.88, maxZ = 33.48},
        }
    },
    ['MRPD'] = {
        settings = {
